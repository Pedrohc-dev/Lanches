...
namespace Lanches.Areas.Admin.Controllers
{
    ...
    public class AdminLanchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LancheId,Nome,DescricaoCurta,DescriaoDetalhada,Preco,ImagemURL,ImagemThumbnailURL,IsLanchePreferido,EmEstoque,CategoriaId")] Lanche lanche)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewBag.CategoriaId = new SelectList(_context.Categorias, "CategoriaId", "Nome", lanche.CategoriaId);
            return View(lanche);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LancheId,Nome,DescricaoCurta,DescriaoDetalhada,Preco,ImagemURL,ImagemThumbnailURL,IsLanchePreferido,EmEstoque,CategoriaId")] Lanche lanche)
        {
